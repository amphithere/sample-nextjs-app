...
})(["margin:20px;padding:20px;text-align:center;border:1px solid gray;:hover{background-color:palevioletred;}h3{align-self:end;justify-self:end;:hover{color:white;}}"]);
...
//# sourceMappingURL=[albumID].js.26a13b1b7b1b61578f99.hot-update.js.map